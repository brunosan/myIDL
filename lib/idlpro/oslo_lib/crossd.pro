...
;
; OUTPUTS:
;	X & Y = Position of extrem, taking CC(1,1) as centre.
;
; SIDE EFFECTS:
;	None.
;
...
ON_ERROR,2
	...
	CASE 1 OF				;Array CC is FLTARR(3,3).
		n(0) EQ 2: BEGIN
			c4 = cc(2,1) + cc(0,1) - cc(1,1)*2.
			c2 = cc(2,1) - cc(0,1)
			c5 = cc(1,2) + cc(1,0) - cc(1,1)*2.
			c3 = cc(1,2) - cc(1,0)
			c6 = (cc(2,2) - cc(0,2) - cc(2,0) + cc(0,0))/4.
		END
		n(0) EQ 3: BEGIN		;Array CC is FLTARR(*,3,3)
			c4 = cc(*,2,1) + cc(*,0,1) - cc(*,1,1)*2.
			c2 = cc(*,2,1) - cc(*,0,1)
			c5 = cc(*,1,2) + cc(*,1,0) - cc(*,1,1)*2.
			c3 = cc(*,1,2) - cc(*,1,0)
			c6 = (cc(*,2,2) - cc(*,0,2) - cc(*,2,0) + cc(*,0,0))/4.
		END
		n(0) EQ 4: BEGIN		;Array CC is FLTARR(*,*,3,3)
			c4 = cc(*,*,2,1) + cc(*,*,0,1) - cc(*,*,1,1)*2.
			c2 = cc(*,*,2,1) - cc(*,*,0,1)
			c5 = cc(*,*,1,2) + cc(*,*,1,0) - cc(*,*,1,1)*2.
			c3 = cc(*,*,1,2) - cc(*,*,1,0)
