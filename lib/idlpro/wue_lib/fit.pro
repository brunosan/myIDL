...
;          cur = [FTYPE, XOFF, YOFF, NDEG, C0, C1, ..., Cn] for polynomial, 
;          cur = [FTYPE, XOFF, YOFF, A, B] for exponential and power law. 
;          Useful for generating data using the fitted curve by calling 
;	   y = gen_fit( x, cur),  x and cur are inputs, y is generated output. 
;       
; COMMON BLOCKS:
; NOTES:
