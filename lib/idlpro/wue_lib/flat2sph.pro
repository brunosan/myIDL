...
; CATEGORY:
; CALLING SEQUENCE:
;       flat2sph,flat,lng1,lng2,lat1,lat2,sphere,lng0,lat0,r,nx,ny
; INPUTS:
;       flat = array containing flat map.                                  in 
;         Longitude in X, Latitude in Y.
;       lng1, lng2 = start and end longitude in flat in X (in degrees).    in 
;       lat1, lat2 = start and end latitude in flat in Y (in degrees).     in 
;       lng0, lat0 = Longitude and Latitude of center of sphere (degrees). in 
