...
; OUTPUTS:
;       k = returned key string.  Either actual key or key name.   out 
;           Waits for a key to be pressed.  No type ahead allowed.
; COMMON BLOCKS:
;       getkey_com
; NOTES:
...
;         best to type slowly when there are pauses between calls, like 
