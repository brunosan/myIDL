...
;-
	...
	FUNCTION MAKEDATA, N, W0, M, SD, SEED0, help=hlp, periodic=per, lastseed=lseed
 
	common makedata_com, seed
 
	NP = N_PARAMS(0)
 
	if (n_params(0) lt 1) or keyword_set(hlp) then begin
	  print,' Make simulated data.  Useful for software development.' 
	  print,' data = makedata( n, [w, m, sd, seed])' 
