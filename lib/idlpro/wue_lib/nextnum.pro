...
;           If returned value is 1 less than lower limit then quit was 
;           selected. Best for a small range of values. 
...
;         The ENTER key gives a menu to select from.  Best for a small range. 
