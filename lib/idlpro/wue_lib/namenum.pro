...
; COMMON BLOCKS:
; NOTES:
;       Notes: Ex1: name='file7.txt' gives pat = 'file#.txt',  i=7 
;         Ex2: name='A1B2C3D' gives pat = 'A#B$C%D', i=1, j=2, k=3 
;         Ex3: name='A0005B' gives pat='A#B', i=5. 
;         If $ and % are not in resulting pattern then j and k did not occur. 
