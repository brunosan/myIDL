...
if n_params() ne 2 then begin
	print
	print, "usage:  graph2, y1, y2"
	print
	print, "	Graph two arrays on one plot."
	print
	print, "	Arguments"
	print, "	    y1,y2	- Y arrays to plot"
	print
	print, "	Keywords"
	print, "	    fileps	- PostScript file (def = graph2.ps)"
...
numx = n_elements(y1)
if n_elements(fileps) eq 0 then fileps = 'graph2.ps'
