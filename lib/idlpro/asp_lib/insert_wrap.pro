pro insert_wrap, array, ix1, ix2, array2, ixmid
;+
;
;	procedure:  insert_wrap
;
...
if n_params() ne 5 then begin
	print
	print, "usage:  insert_wrap, array, ix1, ix2, array2, ixmid"
	print
...
if (i1 lt ix1) and (i2 gt ix2) then begin			; overlap
	print
	print, 'No overlapping allowed in "insert_wrap".'
	print
	return
	...
	d = ix1 - i1
	array(ix2-d+1:ix2) = array2(0:d-1)
	array(ix1:ix1+width-d-1) = array2(d:width-1)

endif else begin						; wrap right
	d = i2 - ix2
	array(ix1:ix1+d-1) = array2(width-d:width-1)
	array(ix2-width+d+1:ix2) = array2(0:width-d-1)
