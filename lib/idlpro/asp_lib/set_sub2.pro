...
;
;	notes:  - see set_sub for a version that may be faster (depends on
...
if n_params() ne 2 then begin
	...
	print
	print
	print, "   ex:  print, set_sub2([1, 3, 5, 7], 5)"
	print, "		1  3  7"
	print, "        print, set_sub2([1, 3, 5, 7], [3, 7, 8])"
	print, "		1  5"
	print
	return, -1
endif
...
;
for i = 0, num-1 do $
	if in_set(v3, v2(i), indexes=indexes) then v3(indexes(0)) = -1
;
;	Return new vector.
;
print, timer()
return, v1(where(v3 ne -1))
end
