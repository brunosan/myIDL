pro pltibfz, im1, im2, im3, im4, range1
;+
;
;	Plot four images in PS -- genivdd.pro generates images.
;
;  Continuum, Field Strength, Magnetic Fill Factor, Net Polarization Fraction
;      i            b                   f                      z
;
;==============================================================================
;
...
if n_params() ne 5 then begin
	print
	print, "usage:  pltibfz, im1, im2, im3, im4, range1"
	print
	print, "	Plotting code for Bruce... (see genibfz.pro)."
	print
	return
endif
;-
...
;
@wrap.com
;newwct, 2, cont_col=[255,255,0], nd2_col=[175,175,255]
newwct, 4, cont_col=[255,255,0], nd2_col=[175,175,255]
;
...
image2 = wrap_scale(im2, 2)
image3 = wrap_scale(im3, 1)
image4 = wrap_scale(im4, 2)
;
...
displayctn, ix_gray + num_gray - 1, ix_gray, x, y, xlen_cbar, ylen_cbar
yoff_ctxt = .02
xyouts, x, y - yoff_ctxt, stringit(0), $
	charsize=1.5, charthick=1.8, /normal
xyouts, x + xlen_norm, y - yoff_ctxt, stringit(3500), $
...
displayctn, ix_gray, ix_gray + num_gray - 1, x, y, xlen_cbar, ylen_cbar
yoff_ctxt = .02
xyouts, x, y - yoff_ctxt, stringit(0), $
	charsize=1.5, charthick=1.8, /normal
...
xyouts, x, y - yoff_ctxt, stringit(0), $
	charsize=1.5, charthick=1.8, /normal
xyouts, x + xlen_norm, y - yoff_ctxt, stringit(16) + '%', $
	charsize=1.5, charthick=1.8, /normal, align=1.0
...
xyouts,x_im2_p1+.03,y_im1_p2+.01, '!17Field Strength (Gauss)', $
	 charsize=1.5, $
	charthick=1.8, /normal

xyouts,x_im3_p1+.02,y_im3_p2+.01, '!17Magnetic Fill Factor', $
	 charsize=1.5, $
	charthick=1.8, /normal

xyouts,x_im4_p1,y_im4_p2+.01, '!17Net Polarization Fraction', $
	 charsize=1.5, $
	charthick=1.8, /normal
