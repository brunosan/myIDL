pro ferro3,ang1,ret1,ang2,ret2,mat1,invmat1,eps

;cambio1=45.
;cambio2=45.
m1a=retarder(ang2(0),ret2(0))
m1b=retarder(ang2(1),ret2(1))
m2a=retarder(ang1(0),ret1(0))
m2b=retarder(ang1(1),ret1(1))
m=m1a#m2a
mat1=m
mat1(0,*)=m(0,*)+m(1,*)
m=m1a#m2b
