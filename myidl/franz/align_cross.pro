FUNCTION ALIGN_CROSS,A,B,WX,WY
;+
; NAME:
;	ALIGN_CROSS
;
...
;	------------------------------------------
;	   SQRT(TOTAL(sA^2)/n - (TOTAL(sA)/n)^2)
;
;	Notice that sB does not appear in the denominator, since it
;	remains constant througout.
;
; REFERENCES:
;	Bonet,J.A. et at.: 1992, LEST Technical Report No. 51
;	von der Luhe,O.: 1983, Astron. Astrophys., 119, 85
;	von der Luhe,O. et al.: 1989, Astron. Astrophys., 224, 351
;
...
ON_ERROR,2
	...
	cc = (cc-mab)/sta		;Linear correlation coefficient.
